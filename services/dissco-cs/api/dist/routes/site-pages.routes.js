...
import { isEmailLike, isSitePageContentKey, isSitePageKey, isSitePageKeyPermutation, isSitePageLang, } from '../validators.js';
export function sitePagesRoutes(repository) {
    const app = new Hono();
    app.get('/', async (c) => {
